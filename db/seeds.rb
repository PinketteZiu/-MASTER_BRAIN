...
30.times do
  Brain.create!(name: Faker::Lorem.sentence(word_count: rand(2..5)), price: Faker::Number.number(3), address: Faker::Address.city, latitude: Faker::Address.latitude, longitude: Faker::Address.longitude, user: User.all.sample)
end
